...
//        System.out.println("customLogin token:["+token.getParameterName()+"] value:[" +token.getToken()+"]");
    ...
    public String consent(Principal principal, Model model,
        ...
        if (StringUtils.hasText(userCode)) {
            model.addAttribute("requestURI", "/greeting-oauth2-service/oauth2/device_verification");
        } else {
            model.addAttribute("requestURI", "/greeting-oauth2-service/oauth2/authorize");
        }
